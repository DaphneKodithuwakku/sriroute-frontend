...
class LocationService {
  ...
  static const String googleMapsApiKey = 'AIzaSyDW2rIuK8kD5XBCGlMQQocVD43GGUas0bM';
  ...
  Future<String?> getAddressFromCoordinates(double latitude, double longitude) async {
    try {
      ...
      if (placemarks.isNotEmpty) {
        ...
        return address.isNotEmpty ? address : 'Location at ${latitude.toStringAsFixed(4)}, ${longitude.toStringAsFixed(4)}';
      }
